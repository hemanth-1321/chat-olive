...
from app.lib.pricing import GROQ_BASE_URL, get_cost
...
class LLMWrapper:
    ...
    async def chat_stream(self, messages: list[dict], model: str, provider: str, conversation_id: str, message_id: str) -> AsyncGenerator[str, None]:
        ...
        try:
            base_url, api_key = self._get_config(model)
        ...
        cost = await get_cost(model, prompt_tokens, completion_tokens)
